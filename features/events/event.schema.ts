...
export const eventDraftSchema = z.object({
  ...
  leadCaptureBadgeText: z.string().max(60).optional(),
  leadCaptureHeroSupportText: z.string().max(220).optional(),
  leadCaptureBenefitsText: z.string().max(1200).optional(),
  leadCaptureFormIntroEyebrow: z.string().max(60).optional(),
  leadCaptureFormIntroTitle: z.string().max(140).optional(),
  leadCaptureFormIntroDescription: z.string().max(260).optional(),
  leadCaptureFormTimingText: z.string().max(80).optional(),
  leadCaptureBonusText: z.string().max(240).optional(),
  leadCaptureProofText: z.string().max(120).optional(),
  leadCaptureFooterStatsText: z.string().max(1200).optional(),
  ...
  autoLeadCaptureEmailEnabled: z.boolean().default(true),
  autoPurchaseApprovedEmailEnabled: z.boolean().default(true),
  autoPendingPaymentEmailEnabled: z.boolean().default(true),
