  ...
  if (error && typeof error === "object" && "issues" in error) {
    ...
    if (field) {
      const fieldLabels: Record<string, string> = {
        ...
        leadCaptureBadgeText: "Selo do topo da captação",
        leadCaptureHeroSupportText: "Texto de apoio do topo da captação",
        leadCaptureBenefitsText: "Benefícios da captação",
        leadCaptureFormIntroEyebrow: "Eyebrow do bloco do formulário",
        leadCaptureFormIntroTitle: "Título lateral do formulário",
        leadCaptureFormIntroDescription: "Descrição lateral do formulário",
        leadCaptureFormTimingText: "Texto de tempo do formulário",
        leadCaptureBonusText: "Bloco de bônus da captação",
        leadCaptureProofText: "Prova social da captação",
        leadCaptureFooterStatsText: "Blocos finais da captação",
...
export async function createEventAction(formData: FormData) {
  ...
  const parsed = eventDraftSchema.safeParse({
    ...
    leadCaptureBadgeText: String(formData.get("leadCaptureBadgeText") ?? "").trim() || undefined,
    leadCaptureHeroSupportText: String(formData.get("leadCaptureHeroSupportText") ?? "").trim() || undefined,
    leadCaptureBenefitsText: String(formData.get("leadCaptureBenefitsText") ?? "").trim() || undefined,
    leadCaptureFormIntroEyebrow: String(formData.get("leadCaptureFormIntroEyebrow") ?? "").trim() || undefined,
    leadCaptureFormIntroTitle: String(formData.get("leadCaptureFormIntroTitle") ?? "").trim() || undefined,
    leadCaptureFormIntroDescription: String(formData.get("leadCaptureFormIntroDescription") ?? "").trim() || undefined,
    leadCaptureFormTimingText: String(formData.get("leadCaptureFormTimingText") ?? "").trim() || undefined,
    leadCaptureBonusText: String(formData.get("leadCaptureBonusText") ?? "").trim() || undefined,
    leadCaptureProofText: String(formData.get("leadCaptureProofText") ?? "").trim() || undefined,
    leadCaptureFooterStatsText: String(formData.get("leadCaptureFooterStatsText") ?? "").trim() || undefined,
