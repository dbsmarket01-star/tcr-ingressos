...
const companySettingsTemplateSelect = {
  ...
  footerCancellationPolicyTitle: true,
...
async function upsertOrganizationCompanySettings(
  ...
  return tx.companySettings.upsert({
    ...
    create: {
      ...
      footerCancellationPolicyTitle: template?.footerCancellationPolicyTitle ?? null,
      footerCancellationPolicyContent: template?.footerCancellationPolicyContent ?? null,
